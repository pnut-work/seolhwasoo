...
// const select_list = document.querySelector('.select_lang_list');
// const t_lang = document.querySelector('.t_lang');
...
//     t_lang.classList.add('show');
//   } else {
//     select_list.classList.remove('show');
//     t_lang.classList.remove('show');
//   }